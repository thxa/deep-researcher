...
- **Range**: 1 (perfect) → ∞ (worst). GPT-2 achieves ~18 on PTB; GPT-3 ~13.
...
- SOTA: GPT-4 ~86.4%, Claude 3 Opus ~75.2%, Llama-3-70B ~82.0%.
...
```
  ...
  │  │  ────────────────────────────────────────────             │   │
  │  │  • 16 scenarios × 7 metrics = 42 evaluation points       │   │
...
5. Zhang, T., Kishore, V., Wu, F., Weinberger, K. Q., & Artzi, Y. (2020). "BERTScore: Evaluating Text Generation with BERT." *Proceedings of the 8th International Conference on Learning Representations (ICLR 2020)*. arXiv: [1904.09775](https://arxiv.org/abs/1904.09775)
...
14. Liang, P. P., Yang, J., Yeh, I. C., Kwon, N., Sheng, L., Ehrenberger, L., Raghavan, R., et al. (2023). "Holistic Evaluation of Language Models (HELM)." *Proceedings of the 2023 Conference on Empirical Methods in Natural Language Processing (EMNLP 2023)*. arXiv: [2211.09110](https://arxiv.org/abs/2211.09110)
...
33. Liu, J., Xia, C., Wang, Y., & Zhang, L. (2024). "EvalPlus: Rigorous Evaluation of LLM-Generated Code." *Proceedings of the 62nd Annual Meeting of the Association for Computational Linguistics (ACL 2024)*. arXiv: [2305.01210](https://arxiv.org/abs/2305.01210)
...
35. Wang, Y., Xia, Y., Zhao, H., et al. (2024). "PromptrBench: Evaluating Large Language Models on Prompt Robustness." *Proceedings of the 2024 Conference of the North American Chapter of the Association for Computational Linguistics (NAACL 2024)*. arXiv: [2307.14776](https://arxiv.org/abs/2307.14776)
