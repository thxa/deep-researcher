...
4. [CTF Wiki — Kernel Pwn](https://ctf-wiki.org/) — Kernel challenge techniques and writeups
5. [Linux Kernel Exploitation](https://github.com/yuawn/Linux-Kernel-Exploitation) — Progressive kernel exploitation exercises
